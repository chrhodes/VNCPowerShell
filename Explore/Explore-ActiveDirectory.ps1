...
Get-ADGroupMember "xxx IT - Environment Support"
Get-ADUser -Filter 'Name -like "*rhodes*"'

Get-ADGroupMember "xxx-GL-TFS-xxx_BA"
...
Get-ADGroup "xxx-DL-xxx-RO" | 
    Sort-Object Name | 
    Select-Object Name, SamAccountName, GroupCategory, GroupScope, @{n="Count"; e={(Get-ADGroupMember $_.Name).Count }} 

Get-ADGroup xxx-GL-TFS-xxx_BA | 
    Sort-Object Name | 
    Select-Object Name, SamAccountName, GroupCategory, GroupScope, @{n="Count"; e={(Get-ADGroupMember $_.Name).Count }} 
...
Get-ADGroup -Filter * | 
    ...
    Export-csv -Path C:\temp\ADGroups.csv

Get-ADGroupMember Administrators 

Get-ADGroupMember Administrators | Get-Member
Get-ADGroupMember Administrators -Server devxxxint.devpl01.net
...
Get-ADGroup -filter 'Name -like "xxx-DL-xxx-RO"' | 
    Get-ADGroupMember | Sort-Object Name |
    Format-Table -Property name, SamAccountName > "xxx-DL-xxx-RO.txt"
...
"FACA-DL-IT-SOA", "xxx-DL-xxx Services", "xxx-DL-xxx Services Admin", "xxx-DL-xxx Group", "xxx-GU-MWMSupport", "xxx-GU-MWMDevelopment", "xxx-GU-MWMAdmins" |
ForEach-Object {
    $_
...
Get-ADGroup -filter 'Name -like "xxx-DL-xxx Group"' | 
    Get-ADGroupMember | 
    Format-Table -Property name, SamAccountName

Get-ADGroup -filter 'Name -like "xxx-DL-xxx Services"' | 
    Get-ADGroupMember | 
    Format-Table -Property name, SamAccountName

Get-ADGroup -filter 'Name -like "xxx-DL-xxx Services Admin"' | 
    Get-ADGroupMember | 
    Format-Table -Property name, SamAccountName
