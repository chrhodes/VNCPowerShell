...
cd C:\temp\xxx\2017.09.06
cd C:\temp\xxx\2017.09.06
cd C:\temp\xxx\xxx_13Sep2017
cd C:\temp\xxx\xxx1_13Sep2017


$logfile = "xxx.log"
$logfile = "xxx0001.log"
$logfile = "xxx.2017-09-09.log"

$logfile = "xxx.2017-09-150001.log"
...
$logfiles = Get-ChildItem xxx0[0-9][0-9][0-9].log

$logfiles = Get-ChildItem xxx*.log


$logfiles = Get-ChildItem *xxx*.log

$logfiles = Get-ChildItem xxx.2017-09-[0-9][0-9].log

$logfiles = Get-ChildItem xxx.log

$logfiles = Get-ChildItem *xxx.log

$logfiles = Get-ChildItem xxx.2017-09-150001.log
$logfiles = Get-ChildItem xxx1.2017-09-15.log
...
$debuglogfiles = Get-ChildItem xxx0[0-9][0-9][0-9]*debug*.log
foreach ($file in $debuglogFiles)
{
    Get-Content $file >> "Cummins-Debug2.log"
}

$errorlogfiles = Get-ChildItem xxx0[0-9][0-9][0-9]*error*.log
foreach ($file in $errorlogFiles)
{
    Get-Content $file >> "Cummins-Error.log"
}

cd "D:\Cummins Logs\xxx.2017-09-15\"
$logfiles = Get-ChildItem xxx.2017-09-15.log

cd "C:\temp\xxx\xxx.2017-09-15\"

cd "C:\temp\xxx\xxx_2017Sep26\"
cd "C:\temp\xxx\xxx1_2017Sep26\"
$logfiles = Get-ChildItem xxx*.log
